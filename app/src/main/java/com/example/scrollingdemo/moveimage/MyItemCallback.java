...
import com.example.scrollingdemo.sweapimage.CommonUtils;
import com.example.scrollingdemo.sweapimage.PostArticleImgAdapter;
...
public class MyItemCallback extends ItemTouchHelper.Callback {
    ...
    public MyItemCallback(SwapImageAdapter adapter, List<String> images) {
